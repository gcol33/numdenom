...
| 7 | poisson_gamma | ✓ | GP | ✗ | ✗ | A | ⚠️ crash |
| 8 | poisson_gamma | ✓ | MSGP | ✗ | ✗ | A | ⚠️ crash |
...
| 18 | poisson_gamma | ✓ | GP | RW1 | ✗ | A | ⚠️ crash |
...
### Known Issues
- **GP spatial crash** (rows 7, 8, 18, 27, 38) - segfault during HMC, needs debugging
