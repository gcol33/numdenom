...
cpp_flatten_3d_rowmajor <- function(arr, d1, d2, d3) {
    .Call(`_tulpaRatio_cpp_flatten_3d_rowmajor`, arr, d1, d2, d3)
}

cpp_sample_crt <- function(y, r) {
    .Call(`_tulpaRatio_cpp_sample_crt`, y, r)
}

cpp_sample_crt_sum <- function(y, r) {
    .Call(`_tulpaRatio_cpp_sample_crt_sum`, y, r)
}

cpp_crt_mean <- function(y, r) {
    .Call(`_tulpaRatio_cpp_crt_mean`, y, r)
}
...
cpp_ess_fit <- function(q_init, y_num, y_denom, y_denom_cont, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, prior_params, zi_params, latent_params, st_params, n_iter, n_warmup, seed, verbose) {
    .Call(`_tulpaRatio_cpp_ess_fit`, q_init, y_num, y_denom, y_denom_cont, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, prior_params, zi_params, latent_params, st_params, n_iter, n_warmup, seed, verbose)
}

cpp_ess_get_n_params <- function(X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, zi_params) {
    .Call(`_tulpaRatio_cpp_ess_get_n_params`, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, zi_params)
}

cpp_gibbs_spatial <- function(data_list) {
    .Call(`_tulpaRatio_cpp_gibbs_spatial`, data_list)
}

cpp_gpu_available <- function() {
    .Call(`_tulpaRatio_cpp_gpu_available`)
}
...
cpp_laplace_fit_gp <- function(y, n, X, re_idx, n_re_groups, sigma_re, coords, nn_idx, nn_dist, nn_order, n_spatial, nn, sigma2_gp, phi_gp, cov_type, family, phi = 1.0, max_iter = 100L, tol = 1e-6, n_threads = 1L) {
    .Call(`_tulpaRatio_cpp_laplace_fit_gp`, y, n, X, re_idx, n_re_groups, sigma_re, coords, nn_idx, nn_dist, nn_order, n_spatial, nn, sigma2_gp, phi_gp, cov_type, family, phi, max_iter, tol, n_threads)
}
...
cpp_laplace_fit_multiscale_gp <- function(y, n, X, re_idx, n_re_groups, sigma_re, coords, nn_idx_local, nn_dist_local, nn_order_local, nn_local, nn_idx_regional, nn_dist_regional, nn_order_regional, nn_regional, n_spatial, sigma2_local, phi_local, sigma2_regional, phi_regional, cov_type, family, phi = 1.0, max_iter = 100L, tol = 1e-6, n_threads = 1L) {
    .Call(`_tulpaRatio_cpp_laplace_fit_multiscale_gp`, y, n, X, re_idx, n_re_groups, sigma_re, coords, nn_idx_local, nn_dist_local, nn_order_local, nn_local, nn_idx_regional, nn_dist_regional, nn_order_regional, nn_regional, n_spatial, sigma2_local, phi_local, sigma2_regional, phi_regional, cov_type, family, phi, max_iter, tol, n_threads)
}
...
cpp_pg_get_max_threads <- function() {
    .Call(`_tulpaRatio_cpp_pg_get_max_threads`)
}
...
cpp_pg_binomial_gibbs_spatial <- function(y, n, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, n_iter = 2000L, n_warmup = 1000L, thin = 1L, prior_beta_sd = 10.0, prior_sigma_re_scale = 2.5, prior_tau_shape = 1.0, prior_tau_rate = 0.01, store_eta = FALSE, verbose = TRUE, n_threads = 1L) {
    .Call(`_tulpaRatio_cpp_pg_binomial_gibbs_spatial`, y, n, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_re_scale, prior_tau_shape, prior_tau_rate, store_eta, verbose, n_threads)
}
...
cpp_pg_nngp_log_density_probe <- function(w, sigma2, phi_gp, cov_type, coords, nn_idx, nn_dist, nn_order, nn) {
    .Call(`_tulpaRatio_cpp_pg_nngp_log_density_probe`, w, sigma2, phi_gp, cov_type, coords, nn_idx, nn_dist, nn_order, nn)
}

cpp_pg_binomial_gibbs_gp <- function(y, n, X, re_group, n_re_groups, coords, nn_idx, nn_dist, nn_order, obs_to_loc, n_spatial, nn, sigma2_gp_init, phi_gp_init, cov_type, n_iter = 2000L, n_warmup = 1000L, thin = 1L, prior_beta_sd = 10.0, prior_sigma_re_scale = 2.5, prior_sigma_gp_U = 1.0, prior_sigma_gp_alpha = 0.01, prior_phi_lower = 0.01, prior_phi_upper = 10.0, store_eta = FALSE, verbose = TRUE, n_threads = 1L) {
    .Call(`_tulpaRatio_cpp_pg_binomial_gibbs_gp`, y, n, X, re_group, n_re_groups, coords, nn_idx, nn_dist, nn_order, obs_to_loc, n_spatial, nn, sigma2_gp_init, phi_gp_init, cov_type, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_re_scale, prior_sigma_gp_U, prior_sigma_gp_alpha, prior_phi_lower, prior_phi_upper, store_eta, verbose, n_threads)
}
...
cpp_pg_binomial_gibbs_rsr <- function(y, n, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, rsr_projection, rsr_n, n_iter = 2000L, n_warmup = 1000L, thin = 1L, prior_beta_sd = 10.0, prior_sigma_re_scale = 2.5, prior_tau_shape = 1.0, prior_tau_rate = 0.01, store_eta = FALSE, verbose = TRUE, n_threads = 1L) {
    .Call(`_tulpaRatio_cpp_pg_binomial_gibbs_rsr`, y, n, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, rsr_projection, rsr_n, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_re_scale, prior_tau_shape, prior_tau_rate, store_eta, verbose, n_threads)
}
...
cpp_pg_negbin_gibbs <- function(y, X, group, n_groups, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_scale, prior_r_shape, prior_r_rate, r_init, store_eta, verbose, n_threads) {
    .Call(`_tulpaRatio_cpp_pg_negbin_gibbs`, y, X, group, n_groups, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_scale, prior_r_shape, prior_r_rate, r_init, store_eta, verbose, n_threads)
}
...
cpp_pg_negbin_negbin_gibbs <- function(y_num, y_denom, X_num, X_denom, group, n_groups, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_scale, prior_r_shape, prior_r_rate, r_num_init, r_denom_init, shared, store_eta, verbose, n_threads) {
    .Call(`_tulpaRatio_cpp_pg_negbin_negbin_gibbs`, y_num, y_denom, X_num, X_denom, group, n_groups, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_scale, prior_r_shape, prior_r_rate, r_num_init, r_denom_init, shared, store_eta, verbose, n_threads)
}
...
cpp_pg_negbin_gibbs_spatial <- function(y, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_re_scale, prior_tau_shape, prior_tau_rate, prior_r_shape, prior_r_rate, r_init, store_eta, verbose, n_threads) {
    .Call(`_tulpaRatio_cpp_pg_negbin_gibbs_spatial`, y, X, re_group, n_re_groups, spatial_group, n_spatial_units, adj_list, n_neighbors, n_iter, n_warmup, thin, prior_beta_sd, prior_sigma_re_scale, prior_tau_shape, prior_tau_rate, prior_r_shape, prior_r_rate, r_init, store_eta, verbose, n_threads)
}

cpp_rpg1 <- function(z) {
    .Call(`_tulpaRatio_cpp_rpg1`, z)
}

cpp_rpg <- function(b, z) {
    .Call(`_tulpaRatio_cpp_rpg`, b, z)
}
...
cpp_sghmc_fit <- function(q_init, y_num, y_denom, y_denom_cont, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, prior_params, zi_params, latent_params, st_params, n_iter, n_warmup, batch_size, epsilon, alpha, L, seed, verbose) {
    .Call(`_tulpaRatio_cpp_sghmc_fit`, q_init, y_num, y_denom, y_denom_cont, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, prior_params, zi_params, latent_params, st_params, n_iter, n_warmup, batch_size, epsilon, alpha, L, seed, verbose)
}
...
cpp_chain_concurrency <- function(n_chains, max_concurrent) {
    .Call(`_tulpaRatio_cpp_chain_concurrency`, n_chains, max_concurrent)
}

cpp_chain_visits <- function(n_chains, max_concurrent) {
...
cpp_gradient_check <- function(field, n_obs = 400L, n_units = 25L, n_times = 10L, eps = 1e-5, seed = 42L, mode = "handcoded", precenter = FALSE, family = "binomial", temporal_shared = TRUE, reference = "analytic", zi = "none") {
    .Call(`_tulpaRatio_cpp_gradient_check`, field, n_obs, n_units, n_times, eps, seed, mode, precenter, family, temporal_shared, reference, zi)
}
...
cpp_test_hamiltonian <- function(q, p) {
    .Call(`_tulpaRatio_cpp_test_hamiltonian`, q, p)
}

cpp_test_log_sum_exp <- function(log_vals) {
    .Call(`_tulpaRatio_cpp_test_log_sum_exp`, log_vals)
}

cpp_test_softmax <- function(x) {
    .Call(`_tulpaRatio_cpp_test_softmax`, x)
}

cpp_test_inv_logit <- function(x) {
    .Call(`_tulpaRatio_cpp_test_inv_logit`, x)
}

cpp_test_lgamma <- function(x) {
    .Call(`_tulpaRatio_cpp_test_lgamma`, x)
}

cpp_test_poisson_loglik <- function(y, lambda) {
    .Call(`_tulpaRatio_cpp_test_poisson_loglik`, y, lambda)
}

cpp_test_binomial_loglik <- function(y, n, p) {
    .Call(`_tulpaRatio_cpp_test_binomial_loglik`, y, n, p)
}

cpp_test_negbin_loglik <- function(y, mu, phi) {
    .Call(`_tulpaRatio_cpp_test_negbin_loglik`, y, mu, phi)
}

cpp_test_normal_loglik <- function(y, mu, sigma) {
    .Call(`_tulpaRatio_cpp_test_normal_loglik`, y, mu, sigma)
}

cpp_test_cholesky <- function(A) {
    .Call(`_tulpaRatio_cpp_test_cholesky`, A)
}

cpp_test_matvec <- function(A, x) {
    .Call(`_tulpaRatio_cpp_test_matvec`, A, x)
}

cpp_test_autodiff_gradient <- function(x_vals) {
    .Call(`_tulpaRatio_cpp_test_autodiff_gradient`, x_vals)
}

cpp_test_autodiff_exp_chain <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_exp_chain`, x_val)
}

cpp_test_autodiff_log_likelihood <- function(y, eta) {
    .Call(`_tulpaRatio_cpp_test_autodiff_log_likelihood`, y, eta)
}

cpp_test_autodiff_division <- function(a_val, b_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_division`, a_val, b_val)
}

cpp_test_autodiff_lgamma <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_lgamma`, x_val)
}

cpp_test_autodiff_softplus <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_softplus`, x_val)
}

cpp_test_autodiff_inv_logit <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_inv_logit`, x_val)
}

cpp_test_autodiff_log <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_log`, x_val)
}

cpp_test_autodiff_sqrt <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_sqrt`, x_val)
}

cpp_test_autodiff_pow <- function(x_val, p) {
    .Call(`_tulpaRatio_cpp_test_autodiff_pow`, x_val, p)
}

cpp_test_autodiff_log1p <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_log1p`, x_val)
}

cpp_test_autodiff_log_sum_exp <- function(a_val, b_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_log_sum_exp`, a_val, b_val)
}

cpp_test_autodiff_logit <- function(x_val) {
    .Call(`_tulpaRatio_cpp_test_autodiff_logit`, x_val)
}
...
cpp_test_pg_update_beta <- function(kappa, omega, X, re_contrib, prior_sd) {
    .Call(`_tulpaRatio_cpp_test_pg_update_beta`, kappa, omega, X, re_contrib, prior_sd)
}

cpp_test_pg_update_re <- function(kappa, omega, X_beta, group, n_groups, sigma_re) {
    .Call(`_tulpaRatio_cpp_test_pg_update_re`, kappa, omega, X_beta, group, n_groups, sigma_re)
}

cpp_test_pg_update_sigma_re <- function(re, scale) {
    .Call(`_tulpaRatio_cpp_test_pg_update_sigma_re`, re, scale)
}

cpp_test_dot_product <- function(x, y) {
    .Call(`_tulpaRatio_cpp_test_dot_product`, x, y)
}

cpp_test_norm_squared <- function(x) {
    .Call(`_tulpaRatio_cpp_test_norm_squared`, x)
}

cpp_test_vector_sum <- function(x) {
    .Call(`_tulpaRatio_cpp_test_vector_sum`, x)
}

cpp_test_axpy <- function(a, x, y) {
    .Call(`_tulpaRatio_cpp_test_axpy`, a, x, y)
}

cpp_test_scale <- function(a, x) {
    .Call(`_tulpaRatio_cpp_test_scale`, a, x)
}

cpp_test_linalg_matvec <- function(X, beta) {
    .Call(`_tulpaRatio_cpp_test_linalg_matvec`, X, beta)
}

cpp_test_linalg_matvec_add <- function(X, beta, y_init) {
    .Call(`_tulpaRatio_cpp_test_linalg_matvec_add`, X, beta, y_init)
}

cpp_test_linalg_matvec_transpose <- function(X, x) {
    .Call(`_tulpaRatio_cpp_test_linalg_matvec_transpose`, X, x)
}

cpp_test_sparse_laplacian_quadform <- function(row_ptr, col_idx, x) {
    .Call(`_tulpaRatio_cpp_test_sparse_laplacian_quadform`, row_ptr, col_idx, x)
}

cpp_test_linalg_log_sum_exp <- function(a, b) {
    .Call(`_tulpaRatio_cpp_test_linalg_log_sum_exp`, a, b)
}

cpp_test_linalg_log_sum_exp_vec <- function(x) {
    .Call(`_tulpaRatio_cpp_test_linalg_log_sum_exp_vec`, x)
}

cpp_test_softmax_inplace <- function(x) {
    .Call(`_tulpaRatio_cpp_test_softmax_inplace`, x)
}

cpp_test_compute_linear_predictors <- function(X_num, beta_num, X_denom, beta_denom, n_threads) {
    .Call(`_tulpaRatio_cpp_test_compute_linear_predictors`, X_num, beta_num, X_denom, beta_denom, n_threads)
}

cpp_test_rw1_quadratic_form <- function(phi, cyclic) {
    .Call(`_tulpaRatio_cpp_test_rw1_quadratic_form`, phi, cyclic)
}

cpp_test_rw2_quadratic_form <- function(phi, cyclic) {
    .Call(`_tulpaRatio_cpp_test_rw2_quadratic_form`, phi, cyclic)
}

cpp_test_ar1_log_density <- function(phi, rho, tau) {
    .Call(`_tulpaRatio_cpp_test_ar1_log_density`, phi, rho, tau)
}
...
cpp_test_log1pexp <- function(x) {
    .Call(`_tulpaRatio_cpp_test_log1pexp`, x)
}

cpp_test_zi_logistic <- function(x) {
    .Call(`_tulpaRatio_cpp_test_zi_logistic`, x)
}

cpp_test_log_logistic <- function(x) {
    .Call(`_tulpaRatio_cpp_test_log_logistic`, x)
}

cpp_test_log1m_logistic <- function(x) {
    .Call(`_tulpaRatio_cpp_test_log1m_logistic`, x)
}

cpp_test_zi_poisson_lpmf <- function(y, mu) {
    .Call(`_tulpaRatio_cpp_test_zi_poisson_lpmf`, y, mu)
}

cpp_test_zi_negbin_lpmf <- function(y, mu, phi) {
    .Call(`_tulpaRatio_cpp_test_zi_negbin_lpmf`, y, mu, phi)
}

cpp_test_zi_poisson_lpmf_logit <- function(y, mu, logit_zi) {
    .Call(`_tulpaRatio_cpp_test_zi_poisson_lpmf_logit`, y, mu, logit_zi)
}

cpp_test_zi_negbin_lpmf_logit <- function(y, mu, phi, logit_zi) {
    .Call(`_tulpaRatio_cpp_test_zi_negbin_lpmf_logit`, y, mu, phi, logit_zi)
}

cpp_test_truncated_poisson_lpmf <- function(y, mu) {
    .Call(`_tulpaRatio_cpp_test_truncated_poisson_lpmf`, y, mu)
}

cpp_test_truncated_negbin_lpmf <- function(y, mu, phi) {
    .Call(`_tulpaRatio_cpp_test_truncated_negbin_lpmf`, y, mu, phi)
}

cpp_test_hurdle_poisson_lpmf_logit <- function(y, mu, logit_theta) {
    .Call(`_tulpaRatio_cpp_test_hurdle_poisson_lpmf_logit`, y, mu, logit_theta)
}

cpp_test_hurdle_negbin_lpmf_logit <- function(y, mu, phi, logit_theta) {
    .Call(`_tulpaRatio_cpp_test_hurdle_negbin_lpmf_logit`, y, mu, phi, logit_theta)
}

cpp_test_zi_log_likelihood <- function(y, mu, phi, logit_zi, zi_type_str) {
    .Call(`_tulpaRatio_cpp_test_zi_log_likelihood`, y, mu, phi, logit_zi, zi_type_str)
}

cpp_test_zi_poisson_grad_logit_zi <- function(y, mu, logit_zi) {
    .Call(`_tulpaRatio_cpp_test_zi_poisson_grad_logit_zi`, y, mu, logit_zi)
}

cpp_test_zi_negbin_grad_logit_zi <- function(y, mu, phi, logit_zi) {
    .Call(`_tulpaRatio_cpp_test_zi_negbin_grad_logit_zi`, y, mu, phi, logit_zi)
}

cpp_test_hurdle_grad_logit_theta <- function(y, logit_theta) {
    .Call(`_tulpaRatio_cpp_test_hurdle_grad_logit_theta`, y, logit_theta)
}

cpp_test_get_max_threads <- function() {
    .Call(`_tulpaRatio_cpp_test_get_max_threads`)
}

cpp_test_parallel_dot_products <- function(X, y, n_threads) {
    .Call(`_tulpaRatio_cpp_test_parallel_dot_products`, X, y, n_threads)
}

cpp_test_parallel_likelihood <- function(y, mu, n_threads) {
    .Call(`_tulpaRatio_cpp_test_parallel_likelihood`, y, mu, n_threads)
}
...
cpp_tulpaRatio_run_nuts_specs <- function(y_num, y_denom, y_num_cont, y_denom_cont, X_list, cfg_list, init, n_iter, n_warmup, max_treedepth = 10L, adapt_delta = 0.8, seed = 1L, verbose = FALSE, gradient_mode = "A_r", sigma_beta = 2.5, phi_prior_shape = 1.0, phi_prior_rate = 0.01, sigma_prior_scale = 1.0, re_params, spatial_params, temporal_params) {
    .Call(`_tulpaRatio_cpp_tulpaRatio_run_nuts_specs`, y_num, y_denom, y_num_cont, y_denom_cont, X_list, cfg_list, init, n_iter, n_warmup, max_treedepth, adapt_delta, seed, verbose, gradient_mode, sigma_beta, phi_prior_shape, phi_prior_rate, sigma_prior_scale, re_params, spatial_params, temporal_params)
}
...
cpp_vi_get_n_params <- function(X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, zi_params) {
    .Call(`_tulpaRatio_cpp_vi_get_n_params`, X_num, X_denom, model_type_str, re_params, spatial_params, temporal_params, zi_params)
}
