...
When spatial patterns change over time (or temporal trends differ across space), additive models may be insufficient. ratiod supports spatiotemporal interaction effects following Knorr-Held (2000).
...
```{r}
fit_type1 <- ratiod(..., spatiotemporal = spatiotemporal(..., type = "I"))
fit_type4 <- ratiod(..., spatiotemporal = spatiotemporal(..., type = "IV"))
