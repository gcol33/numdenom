...
test_that("build_re_structure handles no random effects", {
  ...
  result <- tulpaRatio:::build_re_structure(formula_obj, df)
...
test_that("build_spatial_structure handles no spatial", {
  ...
  result <- tulpaRatio:::build_spatial_structure(NULL, df)
...
test_that("build_spatial_structure works with adjacency matrix", {
  ...
  df <- data.frame(y = 1:4)
  result <- tulpaRatio:::build_spatial_structure(spatial, df)
...
test_that("build_spatial_structure errors with missing group_var", {
  ...
  expect_error(
    tulpaRatio:::build_spatial_structure(spatial, df),
    "group_var"
  )
})
...
test_that("make_standata works for negbin model", {
  ...
  standata <- tulpaRatio:::make_standata(formula_obj, family, df)
...
test_that("make_standata rejects binomial with y_num > y_denom", {
  ...
  expect_error(
    tulpaRatio:::make_standata(formula_obj, family, df),
    "cannot exceed"
  )
})
...
test_that("make_standata with spatial structure", {
  ...
  family <- ratiod_poisson_gamma()
  standata <- tulpaRatio:::make_standata(formula_obj, family, df, spatial = spatial)
...
test_that("make_standata with custom priors", {
  ...
  standata <- tulpaRatio:::make_standata(formula_obj, family, df, priors = custom_priors)
