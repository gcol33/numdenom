# Benchmark rows 22-23, 26-27 from gradient_methods.md
# (Skipping row 21 GP+RW1 - will be ~400s based on row 7)
# Row 22: poisson_gamma + RE + HSGP + RW1
# Row 23: poisson_gamma + RE + MSGP + RW1 (likely crash)
...
results <- list()
cat("\n", strrep("=", 60), "\n")
cat("Benchmarking poisson_gamma HSGP/MSGP+temporal and SVC/TVC\n")
cat(strrep("=", 60), "\n\n")
...
# Row 23: MSGP + RW1 (likely crash based on row 9)
cat("\n")
results[[2]] <- run_bench(
...
saveRDS(results, "benchmarks/results_rows_22_27.rds")
cat("\nResults saved to benchmarks/results_rows_22_27.rds\n")
