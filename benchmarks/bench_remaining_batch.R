...
remaining_benchmarks <- list(
  ...
  list(batch=1, row=37, name="nb_gp",
       call=quote(ratiod(y | denom ~ x + (1 | site), data=df_nb, family=ratiod_negbin_negbin(),
  ...
  list(batch=4, row=67, name="bin_gp",
       call=quote(ratiod(y | trials ~ x + (1 | site), data=df_bin, family=ratiod_binomial(),
                         spatial=spatial_gp(~ lon + lat)))),
  ...
  list(batch=7, row=9, name="pg_msgp",
       call=quote(ratiod(y | effort ~ x + (1 | site), data=df_pg, family=ratiod_poisson_gamma(),
                         spatial=spatial_multiscale(~ lon + lat)))),
  ...
  list(batch=9, row=93, name="gg_base",
       call=quote(ratiod(y | denom ~ x, data=df_gamma, family=ratiod_gamma_gamma()))),
  list(batch=9, row=94, name="gg_re",
       call=quote(ratiod(y | denom ~ x + (1 | site), data=df_gamma, family=ratiod_gamma_gamma()))),
  ...
  list(batch=10, row=98, name="ln_base",
       call=quote(ratiod(y | denom ~ x, data=df_ln, family=ratiod_lognormal()))),
  list(batch=10, row=99, name="ln_re",
       call=quote(ratiod(y | denom ~ x + (1 | site), data=df_ln, family=ratiod_lognormal()))),
  ...
  list(batch=11, row=103, name="bb_base",
       call=quote(ratiod(y | trials ~ x, data=df_bb, family=ratiod_beta_binomial()))),
  list(batch=11, row=104, name="bb_re",
       call=quote(ratiod(y | trials ~ x + (1 | site), data=df_bb, family=ratiod_beta_binomial()))),
