// Joint NegBin-Gamma model with SHARED random effects
// Matches numdenom ratiod_negbin_gamma() with (1|site)
// Row 109 in gradient_methods.md
//
// Hybrid of NB-NB (numerator) and PG (denominator) with shared RE:
// - Numerator: NegBin(exp(eta_num + re[g]), phi_num)
// - Denominator: Gamma(phi_denom, phi_denom / exp(eta_denom + re[g]))
// - Random effect is SHARED between num and denom (numdenom default)
