// Joint Poisson-Gamma model with SHARED random effects + ICAR spatial + RW1 temporal
// Matches numdenom ratiod_poisson_gamma() with (1|site) + spatial_car() + temporal_rw1()
// Row 18 in gradient_methods.md
//
