// Joint NegBin-NegBin model with SHARED correlated random slopes + ICAR spatial
// Matches numdenom ratiod_negbin_negbin() with (1 + x|site) + spatial_car()
// Row 55 in gradient_methods.md
//
...
parameters {
  vector[p] beta_num;
  vector[p] beta_denom;
  real<lower=0> phi_num;               // NegBin overdispersion
