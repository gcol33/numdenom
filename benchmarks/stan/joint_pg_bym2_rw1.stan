// Joint Poisson-Gamma model with SHARED RE + BYM2 spatial + RW1 temporal
// Matches numdenom ratiod_poisson_gamma() with (1|site) + spatial_bym2() + temporal_rw1()
// Row 19 in gradient_methods.md
//
