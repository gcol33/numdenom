// Joint NegBin-NegBin model with SHARED random effects + ICAR spatial + RW1 temporal
// Matches numdenom ratiod_negbin_negbin() with (1|site) + spatial_car() + temporal_rw1()
// Row 48 in gradient_methods.md
//
// KEY INSIGHT: RE, spatial, and temporal effects are all SHARED between num and denom
//
// ICAR prior: phi_s ~ CAR(tau_s, W)
// RW1 prior: phi_t[t] - phi_t[t-1] ~ N(0, 1/tau_t)
