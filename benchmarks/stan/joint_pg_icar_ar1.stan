// Joint Poisson-Gamma model with SHARED random effects + ICAR spatial + AR1 temporal
// Matches numdenom ratiod_poisson_gamma() with (1|site) + spatial_car() + temporal_ar1()
// Row 20 in gradient_methods.md
//
...
parameters {
  ...
  real<lower=-1,upper=1> rho_ar1;      // AR1 coefficient
}
