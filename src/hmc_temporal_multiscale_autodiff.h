...
#ifndef RATIOD_HMC_TEMPORAL_MULTISCALE_AUTODIFF_H
#define RATIOD_HMC_TEMPORAL_MULTISCALE_AUTODIFF_H
...
namespace ratiod_multiscale_ad {
...
#endif  // RATIOD_HMC_TEMPORAL_MULTISCALE_AUTODIFF_H
