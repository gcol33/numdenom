...
#ifndef RATIOD_HMC_LATENT_AUTODIFF_H
#define RATIOD_HMC_LATENT_AUTODIFF_H
...
namespace ratiod_latent_ad {

using ratiod_latent::LatentConstraint;
using ratiod_latent::LatentFactorData;
...
#endif  // RATIOD_HMC_LATENT_AUTODIFF_H
