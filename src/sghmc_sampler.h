...
#ifndef RATIOD_SGHMC_SAMPLER_H
#define RATIOD_SGHMC_SAMPLER_H
...
namespace ratiod_sghmc {

using ratiod_hmc::ModelData;
using ratiod_hmc::ParamLayout;
using ratiod_hmc::ModelType;
using ratiod_hmc::compute_gradient;
using ratiod_hmc::compute_log_post;
