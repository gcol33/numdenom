...
// installing tulpaRatio. No recompilation needed.
//
...
#ifndef RATIOD_GPU_BACKEND_H
#define RATIOD_GPU_BACKEND_H
...
// CUDA implementation is opt-in via RATIOD_ENABLE_CUDA define
// This avoids potential load-time crashes on systems with partial CUDA installations
#ifdef RATIOD_ENABLE_CUDA
#include "gpu_cuda.h"
#else
